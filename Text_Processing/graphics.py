...
File: graphics.py
Authors: , Lisa Yan and Nick Troccoli
Version Date: Apr 10, 2024
This is the official graphics.py file for Project Spr 24.

This library is a lightweight wrapper around the tkinter library to make it easier to create graphical programs for Project students. You can always use
